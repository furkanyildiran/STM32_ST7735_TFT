...
static uint8_t arr[96][8]={
		...
		{0x20,0x30,0x18,0x0C,0x04,0x00,0x00,0x00},//`
		{0x00,0x00,0x3C,0x06,0x3E,0x66,0x66,0x3E},//a1
		{0x60,0x60,0x7C,0x76,0x62,0x62,0x76,0x3C},//b
		{0x00,0x00,0x3C,0x66,0x40,0x40,0x66,0x3C},//c1
		{0x06,0x06,0x3E,0x6E,0x46,0x46,0x6E,0x3C},//d
		{0x00,0x00,0x3C,0x66,0x66,0x7C,0x60,0x3C},//e2
		{0x00,0x3C,0x76,0x62,0xF8,0xF8,0x60,0x60},//f
		{0x00,0x3C,0x66,0x66,0x3E,0x02,0x66,0x3C},//g
		{0xC0,0xC0,0xF8,0xFC,0xCC,0xCC,0xCE,0xCE},//h2
		{0x18,0x00,0x7E,0x18,0x18,0x18,0x18,0x7E},//i
		{0x00,0x0E,0x0E,0x04,0x04,0x44,0x6C,0x38},//j
		//{0x60,0x60,0x60,0x66,0x6C,0x78,0x6C,0x66},//k
		{0x60,0x60,0x66,0x6C,0x78,0x5C,0x66,0x62},//k1
		{0x78,0x78,0x18,0x18,0x18,0x18,0x7E,0x7E},//l1
		{0x00,0x00,0x7C,0xFE,0xD6,0xD6,0xD6,0xC6},//m1
		{0x00,0x00,0x3C,0x7E,0x66,0x66,0x66,0x66},//n1
		...
		{0x00,0x00,0x3C,0x26,0x10,0x08,0x64,0x3C},//s1
		...
		{0x00,0x00,0x66,0x66,0x3E,0x06,0x66,0x3C},//y1
...
void ST7735_TFT_writeString(char text[], uint8_t x, uint8_t y, Colors_t charColor, Colors_t backgroundColor){
	for(uint8_t i = 0; text[i] != '\0'; i++, x+=8){
		if((x+8)>128){
			y+=9;
			x=0;
		}
		ST7735_TFT_writeChar(text[i], x, y, charColor, backgroundColor);
	}
}
